...
private val translations: Map<String, Map<AppLanguage, String>> = mapOf(
    ...
    "btn_create_habit" to v("Gewohnheit erstellen", "Creer l'habitude", "Crear habito", "Crea abitudine", "Создать привычку"),
    "btn_configure_more" to v("Weiter anpassen", "Configurer plus", "Personalizar", "Configura di piu", "Настроить подробнее"),
    "btn_create_custom" to v("+ Eigene Gewohnheit", "+ Habitude personnalisee", "+ Habito personalizado", "+ Abitudine personalizzata", "+ Создать свою привычку"),
    ...
    "tracking_type_yesno" to v("Erledigen", "Faire", "Hacer", "Fallo", "Сделать"),
    "tracking_type_yesno_desc" to v("Einfach markieren: erledigt oder nicht", "Marquer simplement: fait ou non", "Solo marcar: hecho o no", "Segna semplicemente: fatto o no", "Просто отметить — сделал или нет"),
    "tracking_type_count" to v("Zaehlen", "Compter", "Contar", "Conta", "Посчитать"),
    "tracking_type_count_desc" to v("Glaser, Seiten, Wiederholungen...", "Verres, pages, repetitions...", "Vasos, paginas, repeticiones...", "Bicchieri, pagine, ripetizioni...", "Стаканы, страницы, подходы..."),
    "tracking_type_duration" to v("Zeit messen", "Chronometrer", "Cronometrar", "Cronometra", "Засечь время"),
    "tracking_type_duration_desc" to v("Minuten Laufen, Meditation, Lernen...", "Minutes de course, meditation, etude...", "Minutos de correr, meditar, estudiar...", "Minuti di corsa, meditazione, studio...", "Минуты бега, медитации, учёбы..."),
    "freq_every_day" to v("Jeden Tag", "Chaque jour", "Cada dia", "Ogni giorno", "Каждый день"),
    "freq_selected_days" to v("Bestimmte Tage", "Choisir des jours", "Dias especificos", "Giorni specifici", "Выбрать дни"),
    "freq_selected_days_desc" to v("Konkrete Wochentage", "Jours precis de la semaine", "Dias concretos de la semana", "Giorni specifici della settimana", "Конкретные дни недели"),
    "freq_times_per_week" to v("X-mal pro Woche", "X fois par semaine", "X veces por semana", "X volte a settimana", "N раз в неделю"),
    "freq_times_per_week_desc" to v("An beliebigen Tagen", "N'importe quels jours", "En cualquier dia", "In qualsiasi giorno", "В любые дни"),
    ...
    "cat_health" to v("Gesundheit", "Sante", "Salud", "Salute", "Здоровье"),
    "cat_sport" to v("Sport", "Sport", "Deporte", "Sport", "Спорт"),
    "cat_mental" to v("Mental", "Mental", "Mental", "Mentale", "Ментальное"),
    "cat_productivity" to v("Produktivitat", "Productivite", "Productividad", "Produttivita", "Продуктивность"),
    "tmpl_drink_water" to v("Wasser trinken", "Boire de l'eau", "Beber agua", "Bere acqua", "Пить воду"),
    "tmpl_vitamins" to v("Vitamine", "Vitamines", "Vitaminas", "Vitamine", "Витамины"),
    "tmpl_healthy_food" to v("Gesund essen", "Manger sainement", "Comer saludable", "Mangiare sano", "Здоровое питание"),
    "tmpl_no_sugar" to v("Kein Zucker", "Sans sucre", "Sin azucar", "Niente zucchero", "Без сахара"),
    "tmpl_sleep_early" to v("Fruh schlafen", "Dormir tot", "Dormir temprano", "Dormire presto", "Сон до 23:00"),
    "tmpl_running" to v("Laufen", "Course", "Correr", "Corsa", "Пробежка"),
    "tmpl_workout" to v("Training", "Entrainement", "Entrenamiento", "Allenamento", "Тренировка"),
    "tmpl_cycling" to v("Radfahren", "Cyclisme", "Ciclismo", "Ciclismo", "Велосипед"),
    "tmpl_stretching" to v("Dehnen", "Etirements", "Estiramiento", "Stretching", "Растяжка"),
    "tmpl_steps" to v("Schritte", "Pas", "Pasos", "Passi", "Шаги"),
    "tmpl_meditation" to v("Meditation", "Meditation", "Meditacion", "Meditazione", "Медитация"),
    "tmpl_no_phone" to v("Ohne Telefon", "Sans telephone", "Sin telefono", "Senza telefono", "Без телефона"),
    "tmpl_gratitude" to v("Dankbarkeit", "Gratitude", "Gratitud", "Gratitudine", "Благодарность"),
    "tmpl_reading" to v("Lesen", "Lecture", "Lectura", "Lettura", "Чтение"),
    "tmpl_journal" to v("Tagebuch", "Journal", "Diario", "Diario", "Дневник"),
    "tmpl_learning" to v("Lernen", "Apprentissage", "Aprendizaje", "Apprendimento", "Обучение"),
    "unit_cup" to v("Tasse", "tasse", "taza", "tazza", "стакан"),
    "unit_min" to v("min", "min", "min", "min", "мин"),
    "unit_steps" to v("Schritte", "pas", "pasos", "passi", "шагов"),
