...
@rem Use persistent project-local Gradle cache unless user explicitly overrides it.
if not defined GRADLE_USER_HOME set "GRADLE_USER_HOME=%APP_HOME%\.gradle-local"

@rem Add default JVM options here. You can also use JAVA_OPTS and GRADLE_OPTS to pass JVM options to this script.
set DEFAULT_JVM_OPTS="-Xmx64m" "-Xms64m"

@rem Fallback for local Android Studio JBR when JAVA_HOME is not configured.
